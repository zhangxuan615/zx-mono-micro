...
const RouteExample = () => {
  return (
    <Router basename={window.__POWERED_BY_QIANKUN__ ? '/react' : '/'}>
      <nav>
        <NavLink exact to="/" className="app-mian-link" activeClassName="app-mian-link-active">
          Home
        </NavLink>
        <Divider type="vertical" />
        <NavLink exact to="/about" className="app-mian-link" activeClassName="app-mian-link-active">
          About
        </NavLink>
      </nav>
...
export default function App(props) {
  ...
  return (
    <div className="app-main">
      ...
      <Button type="primary" onClick={onAppendClick}>
        更改主应用数据
      </Button>
      <LibVersion />
      <HelloModal />
