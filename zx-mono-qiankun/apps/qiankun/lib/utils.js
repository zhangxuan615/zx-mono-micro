...
function getDefaultTplWrapper(id, name) {
  return function (tpl) {
    return '<div id="'
      .concat(getWrapperId(id), '" data-name="')
      .concat(name, '" data-version="')
      .concat(_version.version, '">')
      .concat(tpl, '</div>');
  };
}
...
function validateExportLifecycle(exports) {
  ...
  return (
    (0, _isFunction2.default)(bootstrap) &&
    (0, _isFunction2.default)(mount) &&
    (0, _isFunction2.default)(unmount)
  );
}
