...
function patchAtMounting(appName, elementGetter, sandbox, scopedCSS, excludeAssetFilter) {
  ...
  var patchersInSandbox =
    ((_patchersInSandbox = {}),
    (0, _defineProperty2.default)(
      _patchersInSandbox,
      _interfaces.SandBoxType.LegacyProxy,
      [].concat(basePatchers, [
        function () {
          return (0, _dynamicAppend.patchLooseSandbox)(
            appName,
            elementGetter,
            sandbox.proxy,
            true,
    ...
    (0, _defineProperty2.default)(
      _patchersInSandbox,
      _interfaces.SandBoxType.Proxy,
      [].concat(basePatchers, [
        function () {
          return (0, _dynamicAppend.patchStrictSandbox)(
            appName,
            elementGetter,
            sandbox.proxy,
            true,
    ...
    (0, _defineProperty2.default)(
      _patchersInSandbox,
      _interfaces.SandBoxType.Snapshot,
      [].concat(basePatchers, [
        function () {
          return (0, _dynamicAppend.patchLooseSandbox)(
            appName,
    ...
    _patchersInSandbox);
  return (_a = patchersInSandbox[sandbox.type]) === null || _a === void 0
    ? void 0
    : _a.map(function (patch) {
        return patch();
      });
}
...
function patchAtBootstrapping(appName, elementGetter, sandbox, scopedCSS, excludeAssetFilter) {
  ...
  var patchersInSandbox =
    ((_patchersInSandbox2 = {}),
    (0, _defineProperty2.default)(_patchersInSandbox2, _interfaces.SandBoxType.LegacyProxy, [
      function () {
        return (0, _dynamicAppend.patchLooseSandbox)(
          appName,
          elementGetter,
    ...
    (0, _defineProperty2.default)(_patchersInSandbox2, _interfaces.SandBoxType.Proxy, [
      function () {
        return (0, _dynamicAppend.patchStrictSandbox)(
          appName,
          elementGetter,
    ...
    (0, _defineProperty2.default)(_patchersInSandbox2, _interfaces.SandBoxType.Snapshot, [
      function () {
        return (0, _dynamicAppend.patchLooseSandbox)(
          appName,
          elementGetter,
