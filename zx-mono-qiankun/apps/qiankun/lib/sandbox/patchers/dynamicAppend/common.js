...
function isHijackingTag(tagName) {
  return (
    (tagName === null || tagName === void 0 ? void 0 : tagName.toUpperCase()) === LINK_TAG_NAME ||
...
function isStyledComponentsLike(element) {
  ...
  return (
    !element.textContent &&
    (((_a = element.sheet) === null || _a === void 0 ? void 0 : _a.cssRules.length) ||
      ((_b = getStyledElementCSSRules(element)) === null || _b === void 0 ? void 0 : _b.length))
  );
}
      ...
      switch (element.tagName) {
        ...
        case STYLE_TAG_NAME: {
          ...
          if (scopedCSS) {
            ...
            var linkElementUsingStylesheet =
              ((_a = element.tagName) === null || _a === void 0 ? void 0 : _a.toUpperCase()) ===
                LINK_TAG_NAME &&
            ...
            if (linkElementUsingStylesheet) {
              var _fetch =
                typeof _apis.frameworkConfiguration.fetch === 'function'
                  ? _apis.frameworkConfiguration.fetch
                  : (_b = _apis.frameworkConfiguration.fetch) === null || _b === void 0
                  ? void 0
                  : _b.fn;
        ...
        case SCRIPT_TAG_NAME: {
          ...
          if (src) {
            ...
            var dynamicScriptCommentElement = document.createComment(
              'dynamic script '.concat(src, ' replaced by qiankun')
            );
            dynamicScriptAttachedCommentMap.set(element, dynamicScriptCommentElement);
            return rawDOMAppendOrInsertBefore.call(
              _mountDOM,
          ...
          var dynamicInlineScriptCommentElement = document.createComment(
