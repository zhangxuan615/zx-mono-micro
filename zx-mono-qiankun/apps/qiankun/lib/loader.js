...
function getAppWrapperGetter(
  ...
  return function () {
    if (useLegacyRender) {
      if (strictStyleIsolation)
        throw new _error.QiankunError('strictStyleIsolation can not be used with legacy render!');
      if (scopedCSS)
        throw new _error.QiankunError(
          'experimentalStyleIsolation can not be used with legacy render!'
        );
      var appWrapper = document.getElementById((0, _utils.getWrapperId)(appInstanceId));
      assertElementExist(
        appWrapper,
        'Wrapper element for '
          .concat(appName, ' with instance ')
          .concat(appInstanceId, ' is not existed!')
      );
      return appWrapper;
    }
    ...
    if (phase !== 'unmounted') {
      var errorMsg = (function () {
        switch (phase) {
          case 'loading':
          case 'mounting':
            return 'Target container with '
              .concat(container, ' not existed while ')
              .concat(appName, ' ')
              .concat(phase, '!');

          case 'mounted':
            return 'Target container with '
              .concat(container, ' not existed after ')
              .concat(appName, ' ')
              .concat(phase, '!');
...
function getLifecyclesFromExports(scriptExports, appName, global, globalLatestSetProp) {
  ...
  if (process.env.NODE_ENV === 'development') {
    console.warn(
      '[qiankun] lifecycle not found from '
        .concat(appName, " entry exports, fallback to get from window['")
        .concat(appName, "']")
    );
  ...
  throw new _error.QiankunError(
    'You need to export lifecycle functions in '.concat(appName, ' entry')
  );
}
        ...
        while (1) {
          switch ((_context17.prev = _context17.next)) {
            case 0:
              ...
              (_configuration$singul = configuration.singular),
                (singular = _configuration$singul === void 0 ? false : _configuration$singul),
                (_configuration$sandbo = configuration.sandbox),
                (sandbox = _configuration$sandbo === void 0 ? true : _configuration$sandbo),
                (excludeAssetFilter = configuration.excludeAssetFilter),
                (_configuration$global = configuration.globalContext),
                (globalContext = _configuration$global === void 0 ? window : _configuration$global),
                (importEntryOpts = (0, _tslib.__rest)(configuration, [
                  'singular',
                  'sandbox',
                  'excludeAssetFilter',
                  'globalContext'
            ...
            case 16:
              ...
              strictStyleIsolation =
                (0, _typeof2.default)(sandbox) === 'object' && !!sandbox.strictStyleIsolation;
              ...
              initialAppWrapperGetter = getAppWrapperGetter(
                appName,
                appInstanceId,
                !!legacyRender,
                strictStyleIsolation,
              ...
              if (sandbox) {
                sandboxContainer = (0, _sandbox.createSandboxContainer)(
                  appName, // FIXME should use a strict sandbox logic while remount, see https://github.com/umijs/qiankun/issues/518
                  initialAppWrapperGetter,
                  scopedCSS,
                  useLooseSandbox,
                  excludeAssetFilter,
              ...
              (_mergeWith = (0, _mergeWith3.default)(
                {},
                (0, _addons.default)(global, assetPublicPath),
                lifeCycles,
                function (v1, v2) {
                  return (0, _concat2.default)(
                    v1 !== null && v1 !== void 0 ? v1 : [],
                    v2 !== null && v2 !== void 0 ? v2 : []
                  );
                }
              )),
            ...
            case 35:
              ...
              (_getLifecyclesFromExp = getLifecyclesFromExports(
                ...
                global,
                (_a =
                  sandboxContainer === null || sandboxContainer === void 0
                    ? void 0
                    : sandboxContainer.instance) === null || _a === void 0
                  ? void 0
                  : _a.latestSetProp
              )),
              ...
              (_getMicroAppStateActi = (0, _globalState.getMicroAppStateActions)(appInstanceId)),
                (onGlobalStateChange = _getMicroAppStateActi.onGlobalStateChange),
                (setGlobalState = _getMicroAppStateActi.setGlobalState),
                (offGlobalStateChange = _getMicroAppStateActi.offGlobalStateChange); // FIXME temporary way
                          ...
                          return _regenerator.default.wrap(function _callee2$(_context2) {
                            while (1) {
                              switch ((_context2.prev = _context2.next)) {
                                case 0:
                                  if (process.env.NODE_ENV === 'development') {
                                    marks = (0, _utils.performanceGetEntriesByName)(
                                      markName,
                                      'mark'
                              ...
                              switch ((_context6.prev = _context6.next)) {
                                case 0:
                                  return _context6.abrupt(
                                    'return',
                                    execHooksChain((0, _utils.toArray)(beforeMount), app, global)
                                  );
                              ...
                              switch ((_context9.prev = _context9.next)) {
                                case 0:
                                  return _context9.abrupt(
                                    'return',
                                    execHooksChain((0, _utils.toArray)(afterMount), app, global)
                                  );
                          ...
                          return _regenerator.default.wrap(function _callee11$(_context11) {
                            while (1) {
                              switch ((_context11.prev = _context11.next)) {
                                case 0:
                                  if (process.env.NODE_ENV === 'development') {
                                    measureName = '[qiankun] App '.concat(
                                      appInstanceId,
                                      ' Loading Consuming'
                                    );
                              ...
                              switch ((_context12.prev = _context12.next)) {
                                case 0:
                                  return _context12.abrupt(
                                    'return',
                                    execHooksChain((0, _utils.toArray)(beforeUnmount), app, global)
                                  );
                              ...
                              switch ((_context14.prev = _context14.next)) {
                                case 0:
                                  return _context14.abrupt(
                                    'return',
                                    execHooksChain((0, _utils.toArray)(afterUnmount), app, global)
                                  );
