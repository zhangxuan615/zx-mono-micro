  ...
  if (sandbox) {
    if (!window.Proxy) {
      ...
      return Object.assign(Object.assign({}, configuration), {
        sandbox:
          (0, _typeof2.default)(sandbox) === 'object'
            ? Object.assign(Object.assign({}, sandbox), {
                loose: true
              })
            : {
                loose: true
...
function registerMicroApps(apps, lifeCycles) {
  ...
  microApps = [].concat(
    (0, _toConsumableArray2.default)(microApps),
    (0, _toConsumableArray2.default)(unregisteredApps)
  );
                      ...
                      Object.assign(
                        {
                          ...
                          ].concat((0, _toConsumableArray2.default)((0, _utils.toArray)(mount)), [
                            function () {
                              return (0, _tslib.__awaiter)(
                                _this2,
                                void 0,
...
function loadMicroApp(app, configuration, lifeCycles) {
  ...
  var wrapParcelConfigForRemount = function wrapParcelConfigForRemount(config) {
    ...
    if (container) {
      if (containerXPath) {
        ...
        if (
          containerMicroApps === null || containerMicroApps === void 0
            ? void 0
            : containerMicroApps.length
        ) {
          var mount = [
            function () {
              return (0, _tslib.__awaiter)(
                    ...
                    while (1) {
                      switch ((_context4.prev = _context4.next)) {
                        case 0:
                          ...
                          prevLoadMicroApps = containerMicroApps.slice(
                            0,
                          ...
                          _context4.next = 4;
                          return Promise.all(
                            prevLoadMicroAppsWhichNotBroken.map(function (v) {
    ...
    return (0, _tslib.__awaiter)(
      ...
      /*#__PURE__*/ _regenerator.default.mark(function _callee5() {
        var userConfiguration,
          $$cacheLifecycleByAppName,
          parcelConfigGetterPromise,
          _parcelConfigGetterPromise,
        ...
        return _regenerator.default.wrap(function _callee5$(_context5) {
          while (1) {
            switch ((_context5.prev = _context5.next)) {
              case 0:
                userConfiguration = autoDowngradeForLowVersionBrowser(
                  configuration !== null && configuration !== void 0
                    ? configuration
                    : Object.assign(Object.assign({}, frameworkConfiguration), {
                        singular: false
                      })
                );
              ...
              case 21:
                parcelConfigObjectGetterPromise = (0, _loader.loadApp)(
                  app,
                  userConfiguration,
                  lifeCycles
                );
  ...
  if (!started) {
    ...
    (0, _singleSpa.start)({
      urlRerouteOnly:
        (_a = frameworkConfiguration.urlRerouteOnly) !== null && _a !== void 0
          ? _a
          : defaultUrlRerouteOnly
    });
  }

  microApp = (0, _singleSpa.mountRootParcel)(
    memorizedLoadingFn,
    Object.assign(
      {
...
function start() {
  ...
  var _frameworkConfigurati = frameworkConfiguration,
    ...
    urlRerouteOnly =
      _frameworkConfigurati2 === void 0 ? defaultUrlRerouteOnly : _frameworkConfigurati2,
    importEntryOpts = (0, _tslib.__rest)(frameworkConfiguration, [
      'prefetch',
      'sandbox',
      'singular',
      'urlRerouteOnly'
  ...
  exports.frameworkConfiguration = frameworkConfiguration =
    autoDowngradeForLowVersionBrowser(frameworkConfiguration);
  (0, _singleSpa.start)({
